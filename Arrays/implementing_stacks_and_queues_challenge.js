...
console.log('pop last item', lastFood);
console.log('popped foods remaining:', foods);

//Challenge Question #2
//Remove the first item in the foods array.
const firstFood = foods.shift();
console.log('shift first item', firstFood);
console.log('shifted foods remaining:', foods);

//Challenge Question #3
//Add the variable blackBeans to the beginning of the foods array.
foods.unshift(blackBeans);
console.log('foods after adding food to beginning (unshift):', foods);

//Challenge Question #4
//Add the variable chiaSeeds to the end of the array.
//What does your final array look like?
foods.push(chiaSeeds);
console.log('foods after adding food to the end (push):', foods);
